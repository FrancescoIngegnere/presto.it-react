    ...
    return (
        ...
        <nav
            ...
            <div className="flex w-full flex-wrap items-center justify-between px-3">
                ...
                <button
                    className="block border-0 bg-transparent px-2 text-neutral-500 hover:no-underline hover:shadow-none focus:no-underline focus:shadow-none focus:outline-none focus:ring-0 dark:text-neutral-200 lg:hidden order-2"
                    type="button"
                ...
                <div
                    ...
                    <ul
                        ...
                        <li className="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
                            {/* <!-- Dashboard link --> */}
                            <a
                                className="text-neutral-500 transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400 text-4xl"
                                href="#"
